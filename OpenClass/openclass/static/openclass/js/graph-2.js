...
LINE DRAWING ANIMATION WITH SNAP SVG2

I coded a line drawing animating with snap svg2. The graph is not created out of a single line because the animating with separate paths and easing on each section simply looks better :)
...
var price = [0,-100, -50, -100, -150, -50, -100, -50, -100];
...
//CHART VALUES
var chartH = $('#svg2').height();
var chartW = $('#svg2').width();

// PARSE PRICES TO ALIGN WITH BOTTOM OF OUR SVG2
var prices = [];
for (i = 0; i < price.length; i++) {
    prices[i] = price[i] + $('#svg2').height();
}

function draw() {
    //DEFINE SNAP SVG2 AND DETERMINE STEP NO.
    var paper = Snap('#svg2');
