...
urlpatterns = [
    ...
    path('moderation/attendance/<int:workshop_pk>/', views.attendance, name='moderation_workshop_attendance'),
    path('moderation/attendance/<int:workshop_pk>/<int:user_pk>/', views.user_attendance, name='moderation_user_workshop_attendance'),
